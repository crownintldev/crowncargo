        ...
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-60 max-w-full px-4 xl:mr-12">
              ...
              >
                <h1 className="text-3xl font-bold">Crown Courier</h1>
                {/* <Image
            ...
            <div className="flex w-full items-center justify-between px-4">
              ...
              <Link
                  href="/tracking"
                  className="ease-in-up hidden rounded-md bg-transparent py-1 px-2 text-base font-bold text-white transition duration-300 hover:bg-opacity-90 hover:shadow-signUp md:block md:px-3 lg:px-3 xl:px-3 mr-2 border border-white"
                >
                  Track
                </Link>
                <Link
                  href="/signin"
                  className="ease-in-up hidden rounded-md bg-primary py-1 px-2 text-base font-bold text-white transition duration-300 hover:bg-opacity-90 hover:shadow-signUp md:block md:px-3 lg:px-3 xl:px-3"
                >
                  Sign In
                </Link>
                <div>
